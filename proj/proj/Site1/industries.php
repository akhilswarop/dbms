...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="ADDING A INDUSTRY TO THE DATABASE">
...
<link rel="stylesheet" href="Page-2.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-1607"><div class="u-clearfix u-sheet u-valign-middle-xl u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="sec-ba3c">
	...
	L102.6,160H95.8z M121.8,160l38.2-38.2v6.7L128.5,160H121.8z M147.4,160l12.6-12.6v6.7l-5.9,5.9L147.4,160L147.4,160z"></path></svg>
        ...
        <img class="u-image u-image-default u-image-1" src="images/e1ef9e25ac7e5a6fa52c3c0d867419a138736163d49c5c0c504ffaefe61d95607a1f95a292ccdb47d7914a8423217e56a13e67ad8576d87af880bb_1280.jpg" alt="" data-image-width="1280" data-image-height="959">
        <div class="u-align-center u-container-style u-group u-shape-rectangle u-white u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h1 class="u-text u-text-black u-text-1">ADDING A INDUSTRY TO THE DATABASE</h1>
          </div>
        </div>
        ...
        <div class="u-form u-white u-form-1">
          <form class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" source="email" name="form" method="post">
            <div class="u-form-group u-form-name u-label-top u-form-group-1">
              <label for="name-6797" class="u-label">INDUSTRY ID</label>
              <input type="text" placeholder="enter industry_id" id="name-6797" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-label-top u-form-group-2">
              <label for="email-6797" class="u-label">COMPANY NAME</label>
              <input type="text" placeholder="enter company name" id="email-6797" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="required">
            </div>
