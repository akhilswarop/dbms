...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Update Your Industry Details">
    <meta name="description" content="">
    <title>INDUSTRY UPDATE</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="INDUSTRY-UPDATE.css" media="screen">
    ...
    <meta property="og:title" content="INDUSTRY UPDATE">
            ...
            <div class="u-form u-form-1">
              <form method="post" class="u-clearfix u-form-spacing-37 u-form-vertical u-inner-form" style="padding: 24px;" source="email" name="form">
                ...
                <div class="u-form-group u-form-message u-form-group-3">
                  ...
                  <textarea id="phone-cbff" name="Name-1" class="u-grey-5 u-input u-input-rectangle u-input-3" required="required" placeholder="Enter existing Company Name"></textarea>
                </div>
