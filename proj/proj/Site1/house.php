...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="ADDING A HOUSE TO THE DATABASE">
	...
	L102.6,160H95.8z M121.8,160l38.2-38.2v6.7L128.5,160H121.8z M147.4,160l12.6-12.6v6.7l-5.9,5.9L147.4,160L147.4,160z"></path></svg>
        ...
        <div class="u-align-center u-container-style u-group u-shape-rectangle u-white u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h1 class="u-text u-text-black u-text-1">ADDING A HOUSE TO THE DATABASE</h1>
          </div>
        </div>
        ...
        <div class="u-form u-white u-form-1">
          <form class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" source="email" name="form" method="post">
            ...
            <div class="u-form-group u-form-phone u-label-top u-form-group-2">
              <label for="email-6797" class="u-label">PRIMARY PHONE NUMBER</label>
              <input type="tel" placeholder="enter phone number" id="email-6797" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="required">
            </div>
